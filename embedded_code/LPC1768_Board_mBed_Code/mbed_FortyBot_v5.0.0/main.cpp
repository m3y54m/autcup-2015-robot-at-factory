 ...
 * Date:                  1394/12/08
 * Version:               5.0.0
 * Description: Wall Following using ultrasonic sensors
 */
...
int main() 
{
	...
	{			
		...
		errorDistance[7] = actualDistance[7] - 10;
		errorDistance[6] = actualDistance[6] - 10;
		
		if ( ( abs( errorDistance[7] ) >= 4 ) && ( abs( errorDistance[6] ) >= 4 ) )
		{
				  desiredVy = ( errorDistance[7] + errorDistance[6] ) * 0.33f ;
				  desiredWz = ( errorDistance[7] - errorDistance[6] ) * 1.33f ;		  
		}
